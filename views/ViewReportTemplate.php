...
switch (label) {
 case 'Report Raiser':
                    return '' +
                        ...
                        '<input  name="' + label + '" type="text" id="text-' + label + '" value="" readonly>' +
                        '</div>';
 ...
 case 'Submission Date':
                    return '' +
                        '<div id="sjfb-' + uniqueID + '" class="sjfb-field sjfb-text">' +
                        '<label for="text-' + uniqueID + '"></label>' +
                        '<input name="date" type="date" value="" readonly>' +
                        '</div>';
}
...
<div id="sjfb-wrap" class="col-lg-10">
    ...
    <form id="sjfb-sample" style="max-width:600px !important;" method="post">
        <div id="sjfb-fields">
        
        </div>
        <button type="button" class="btn btn-info">This is only a preview.</button>
