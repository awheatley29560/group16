...
$id = $_GET['id'];
        ...
        if ($valid) {
            ...
            Database::disconnect();
            header("Location: index.php?source=ViewTemplate&msg=act");
        }
    } 
...
<form class="form-horizontal" method="post" action="?source=ActivateTemplate&id=<?php echo $id?>">
<fieldset>
...
Are you sure you want to re-activate Template?
</div>
  <div class="col-md-4">
  <input value="0" id="archive" name="archive" type="text" class="hidden">
  </div>
</div>
